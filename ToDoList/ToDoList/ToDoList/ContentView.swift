...
struct ContentView: View {
    @State private var items: [ToDoItem] = [
        ToDoItem(title: "Kup mleko", isDone: false),
        ToDoItem(title: "Zrób zadanie", isDone: true),
        ToDoItem(title: "Bieganie", isDone: false),
        ToDoItem(title: "Posprzątaj", isDone: true)
    ]
    ...
    private func addTask() {
        let newItem = ToDoItem(title: "", isDone: false)
        withAnimation {
